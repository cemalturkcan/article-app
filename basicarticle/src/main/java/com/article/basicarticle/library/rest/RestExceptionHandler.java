...
public class RestExceptionHandler extends BaseController {
  ...
  public Response<ErrorResponse> handleRequestForbiddenRequest(
      AccessDeniedException accessDeniedException, Locale locale) {
  ...
  public Response<ErrorResponse> handleRequestPropertyBindingError(
  ...
  public Response<ErrorResponse> handleInvalidArgumentException(
    ...
    log.debug(
        "Method argument not valid. Message: $methodArgumentNotValidException.message",
  ...
  public Response<ErrorResponse> handleMethodArgumentTypeMismatchException(
    ...
    return createErrorResponseFromMessageSource(
        "common.client.typeMismatch", locale, methodArgumentTypeMismatchException.getName());
  }
  ...
  public Response<ErrorResponse> handleMethodNotSupportedException(
    ...
    return createErrorResponseFromMessageSource(
        "common.client.methodNotSupported", locale, methodNotSupportedException.getMethod());
  }

  @ExceptionHandler(IllegalArgumentException.class)
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public Response<ErrorResponse> handleMethodNotSupportedException(
      IllegalArgumentException illegalArgumentException, Locale locale) {
    log.debug("HttpRequestMethodNotSupportedException occurred", illegalArgumentException);
    return createErrorResponseFromMessageSource(
        "common.client.argumentNotValid", locale, illegalArgumentException.getMessage());
  }

  private Response<ErrorResponse> createFieldErrorResponse(
      BindingResult bindingResult, Locale locale) {
    List<String> requiredFieldErrorMessages =
        retrieveLocalizationMessage("common.client.requiredField", locale);
  ...
  private Response<ErrorResponse> createErrorResponseFromMessageSource(
